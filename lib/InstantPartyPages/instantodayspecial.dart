...
class InstantSpecial extends StatefulWidget {
  @override
  _InstantSpecialState createState() => _InstantSpecialState();
}

class _InstantSpecialState extends State<InstantSpecial> {
  ...
  getVegData() {
    firestoreInstance
        ...
        .where("veg", isEqualTo: true).where("todays-special",isEqualTo: true)
        .get()
        .then((value) {
  ...
  getnonVegData() {
    firestoreInstance
        .collection("Instant-Package")
        .where("veg", isEqualTo: false).where("todays-special",isEqualTo: true)
        .get()
        .then((value) {
      value.docs.forEach((result) {
        setState(() {
