...
class InstantOffer extends StatefulWidget {
  @override
  _InstantOfferState createState() => _InstantOfferState();
}

class _InstantOfferState extends State<InstantOffer> {
  ...
  getVegData() {
    firestoreInstance
        ...
        .where("veg", isEqualTo: true).where("special-offer",isEqualTo: true)
        .get()
        .then((value) {
  ...
  getnonVegData() {
    firestoreInstance
        .collection("Instant-Package")
        .where("veg", isEqualTo: false).where("special-offer",isEqualTo: true)
        .get()
        .then((value) {
      value.docs.forEach((result) {
        setState(() {
