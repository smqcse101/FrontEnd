...
class SpecialPackage extends StatefulWidget {
  @override
  _SpecialPackageState createState() => _SpecialPackageState();
}

class _SpecialPackageState extends State<SpecialPackage> {
  bool isveg=false;
  ...
  getVegData() {
    firestoreInstance
        ...
        .where("name", isEqualTo: "Special-Package").where("veg",isEqualTo: true)
        .get()
        .then((value) {
  ...
  getNonVegData() {
    firestoreInstance
        .collection("Standard-Package")
        .where("name", isEqualTo: "Special-Package").where("veg",isEqualTo: false)
        .get()
        .then((value) {
      value.docs.forEach((result) {
        setState(() {
